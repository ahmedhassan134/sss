...
class ClassfictionOfVerbal extends StatefulWidget {
  const ClassfictionOfVerbal(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<ClassfictionOfVerbal> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<ClassfictionOfVerbal> {
