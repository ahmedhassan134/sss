...
class IntroOfVerbal extends StatefulWidget {
  IntroOfVerbal(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<IntroOfVerbal> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<IntroOfVerbal> {
