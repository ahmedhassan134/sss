...
class TreatmentOfVerbal extends StatefulWidget {
  const TreatmentOfVerbal(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<TreatmentOfVerbal> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<TreatmentOfVerbal> {
