...
class TaqeemOfVerbal extends StatefulWidget {
  const TaqeemOfVerbal(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<TaqeemOfVerbal> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<TaqeemOfVerbal> {
