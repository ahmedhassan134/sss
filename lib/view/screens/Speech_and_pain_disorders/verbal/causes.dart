...
class CausesOfVerbal extends StatefulWidget {
  const CausesOfVerbal(
      {Key? key,
        required this.title,
        this.titleImagePath,
...
final  String? titleImagePath;
  ...
  @override
  State<CausesOfVerbal> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<CausesOfVerbal> {
