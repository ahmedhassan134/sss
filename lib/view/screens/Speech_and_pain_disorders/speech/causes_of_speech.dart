...
class CausesOfSpeech extends StatefulWidget {
  const CausesOfSpeech(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<CausesOfSpeech> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<CausesOfSpeech> {
