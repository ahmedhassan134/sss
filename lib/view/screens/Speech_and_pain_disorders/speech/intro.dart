...
class IntroductionOfSpeech extends StatefulWidget {
  const IntroductionOfSpeech(
      {Key? key,
        required this.title,
        this.titleImagePath,
 ...
 final String? titleImagePath;
  ...
  @override
  State<IntroductionOfSpeech> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<IntroductionOfSpeech> {
