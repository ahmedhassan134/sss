...
class FamouesOfSpeech extends StatefulWidget {
  const FamouesOfSpeech(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<FamouesOfSpeech> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<FamouesOfSpeech> {
