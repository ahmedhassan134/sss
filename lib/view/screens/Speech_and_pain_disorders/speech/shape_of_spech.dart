...
class ShapeOfSpeech extends StatefulWidget {
  ShapeOfSpeech(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<ShapeOfSpeech> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<ShapeOfSpeech> {
