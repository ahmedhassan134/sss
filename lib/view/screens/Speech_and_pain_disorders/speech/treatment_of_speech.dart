...
class TreatmentOfSpeech extends StatefulWidget {
  const TreatmentOfSpeech(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<TreatmentOfSpeech> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<TreatmentOfSpeech> {
            ...
            child: Column(
              ...
              children:  [
                ...
                const FloatingWidget(
                  heroTag: 'one',
                  urll: 'https://youtu.be/s9_hkVdbg7I',
                ),
