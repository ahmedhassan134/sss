...
class FamilyOfSpeech extends StatefulWidget {
  const FamilyOfSpeech(
      {Key? key,
        required this.title,
        this.titleImagePath,
 ...
 final  String? titleImagePath;
  ...
  @override
  State<FamilyOfSpeech> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<FamilyOfSpeech> {
