...
class TaheelOfStamming extends StatefulWidget {
  const TaheelOfStamming(
      {Key? key,
        required this.title,
        this.titleImagePath,
 ...
 final String? titleImagePath;
  ...
  @override
  State<TaheelOfStamming> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<TaheelOfStamming> {
