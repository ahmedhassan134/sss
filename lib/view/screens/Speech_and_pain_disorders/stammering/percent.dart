...
class PercentOfStamming extends StatefulWidget {
  const PercentOfStamming(
      {Key? key,
        required this.title,
        this.titleImagePath,
 ...
 final  String? titleImagePath;
  ...
  @override
  State<PercentOfStamming> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<PercentOfStamming> {
