...
class ShapeOfStamming extends StatefulWidget {
  const ShapeOfStamming(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<ShapeOfStamming> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<ShapeOfStamming> {
