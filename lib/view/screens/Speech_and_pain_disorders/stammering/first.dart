...
class FirstOfStamming extends StatefulWidget {
  const FirstOfStamming(
      {Key? key,
        required this.title,
        this.titleImagePath,
 ...
 final String? titleImagePath;
  ...
  @override
  State<FirstOfStamming> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<FirstOfStamming> {
