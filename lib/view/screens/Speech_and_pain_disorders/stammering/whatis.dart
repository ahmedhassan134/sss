...
class WhatIsOfStamming extends StatefulWidget {
  const WhatIsOfStamming(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<WhatIsOfStamming> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<WhatIsOfStamming> {
