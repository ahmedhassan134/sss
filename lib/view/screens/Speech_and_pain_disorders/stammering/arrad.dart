...
class AraadOfStamming extends StatefulWidget {
  const AraadOfStamming(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<AraadOfStamming> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<AraadOfStamming> {
