...
class MechanicSpeeking extends StatefulWidget {
  const MechanicSpeeking(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<MechanicSpeeking> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<MechanicSpeeking> {
