...
class MechaniqueProduct extends StatefulWidget {
  const MechaniqueProduct(
      {Key? key,
        required this.title,
        this.titleImagePath,
 ...
 final String? titleImagePath;
  ...
  @override
  State<MechaniqueProduct> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<MechaniqueProduct> {
