...
class CausesOfAbraxia extends StatefulWidget {
  const CausesOfAbraxia(
      {Key? key,
        required this.title,
        this.titleImagePath,
 ...
 final String? titleImagePath;
  ...
  @override
  State<CausesOfAbraxia> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<CausesOfAbraxia> {
