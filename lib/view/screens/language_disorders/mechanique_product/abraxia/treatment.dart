...
class TreatmentOfAbraxia extends StatefulWidget {
  const TreatmentOfAbraxia(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<TreatmentOfAbraxia> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<TreatmentOfAbraxia> {
