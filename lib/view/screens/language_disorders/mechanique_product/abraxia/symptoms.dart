...
class SymptomsOfAbraxia extends StatefulWidget {
  const SymptomsOfAbraxia(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<SymptomsOfAbraxia> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<SymptomsOfAbraxia> {
