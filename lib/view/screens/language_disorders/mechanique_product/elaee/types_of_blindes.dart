...
class TypesOfBlindess extends StatefulWidget {
  const TypesOfBlindess(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<TypesOfBlindess> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<TypesOfBlindess> {
