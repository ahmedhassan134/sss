...
class RehabilitionBlindess extends StatefulWidget {
  const RehabilitionBlindess(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<RehabilitionBlindess> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<RehabilitionBlindess> {
