...
class CausesOfBlindess extends StatefulWidget {
  const CausesOfBlindess(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<CausesOfBlindess> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<CausesOfBlindess> {
