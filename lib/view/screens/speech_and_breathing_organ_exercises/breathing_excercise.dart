...
class BreathingExcercises extends StatelessWidget {
  const BreathingExcercises({Key? key}) : super(key: key);
  static String id = 'BreathingExcercises';
              ...
              child: Column(
                children: const [
                  CustomCommonQuestion(
                      text1: '	التنفس:',
                      text2:
                          '''حتى يتمكن الطفل من الكلام يجب أن يكون قادرا على التقاط أنفاسه بسرعة وإطلاقها بينما هو يقول كلمة أو أكثر.  إذا تنفس الطفل بسرعة أو بطريقة غير منتظمة سوف يجد صعوبة في إصدار صوت يكفي لقول كلمة أو عدة كلمات إليك عدة تمارين تساعد على تحسين التنفس العادي. 
...
'''),
                  CustomCommonQuestion(
                      text1: '	وضعية الجلوس:',
                      text2:
                          '''-	ضعي الطفل على كرسي مقعده مستقيم بحيث يكون رأسه للأعلى وأكتافه للخلف وبهذا تكون العضلات قابلة للتحرك والعمل. 
...
'''),
                  CustomCommonQuestion(
                      text1: 'إصدار الأصوات :',
                      text2:
                          '''-	حث الطفل على أن يتنفس بعمق وعلى إصدار صوت مثل (آه) أثناء عملية الزفير.
...
'''),
                  CustomCommonQuestion(
                      text1: '	تمرين (1) :',
                      text2:
                          '''اضطجع على ظهرك بحيث يكون الجسم حراً من كل رباط أو قيد يعوق حركاته ثم تنفس من أنفك تنفساً عميقاً بطيئاً فتحس أضلاعك تتمدد وبطنك ينتفخ إلى الأمام أما الترقوتان فتظلان ثابتتين وبعد استيعاب الهواء توقف قليلاً ثم اطرد الهواء من الفم بقوة وبصوت مسموع.'''),
                  CustomCommonQuestion(
                      text1: '	تمرين (2) :',
                      text2:
                          '''استيعاب سريع وزفير بطيء ولكي يقف المتمرن على درجة تقدمه يضع إزاء فمه شمعة مضيئة ليعرف مقدرته على إيقاف زفيره من تحرك اللهب'''),
                  CustomCommonQuestion(
                      text1: '	تمرين (3) :',
                      text2: '''استيعاب سريع وزفير سريع'''),
                  CustomCommonQuestion(
                      text1: '	تمرين (4) :',
                      text2: '''استيعاب بطئ وزفير بطئ'''),
                  CustomCommonQuestion(
                      text1: '	وهناك تدريبات اخري للتنفس :',
                      text2: '''الهدف من هذه التدريبات: إطالة التنفس'''),
                  CustomCommonQuestion(
                      text1: '	التدريبات:',
                      text2:
                          '''	النوم في حالة استرخاء ووضع اليد علي البطن نقوم بعملية الشهيق والزفير بعمق من الانف ببطء.
...
'''),
                  CustomCommonQuestion(
                      text1: '	تمارين لتقويه الجهاز التنفسي:',
                      text2:
...
'''),
                  CustomCommonQuestion(
                      text1: '	الأوتار الصوتية :',
                      text2:
                          '''-	القيـام بتقليـد حركات وأصـوات الحيـوانات الأليفـة أو المحببـة لديهم مثـل : صـوت القطة ، الكلب ، الخـروف ،الدجاج ...... الخ
