...
class DiagnosisOfDelayedLanguageGrowth extends StatefulWidget {
  DiagnosisOfDelayedLanguageGrowth(
      {Key? key,
        required this.title,
        this.titleImagePath,
  ...
  @override
  State<DiagnosisOfDelayedLanguageGrowth> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<DiagnosisOfDelayedLanguageGrowth> {
