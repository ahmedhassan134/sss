                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return LanguageAcquisition(
                            ...
                            listOfRichTextWidget:  [
                              MapEntry(
                                const Domain(text: 'المقومات او المتطلبات الضرورية لاكتساب اللغة وتشمل:'),
...
''',),
                              ...
                              MapEntry(
                                const Domain(text: 'أولا: سلامة القنوات الحسية ووظائفها: '),
...
''',),
                              ...
                              MapEntry(
                                const Domain(text: '	ثانيا: سلامة الجهاز العصبي المركزي:'),
...
''',),
                              ...
                              MapEntry(
                                const Domain(text: 'ثالثا: القدرات العقلية:'),
...
''',),
                              ...
                              MapEntry(
                          const Domain(text: '	رابعا: البيئة المحفزة: '),
                ...
                IntroductionToCommunicationScienceButton(
                  onTap: (){
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return DiagnosisOfDelayedLanguageGrowth(
                            title: 'تشخيص حالات تأخر النمو اللغوي ',
                            listOfRichTextWidget:  [
                              MapEntry(
                                  const Domain(text: 'تشخيص حالات تأخر النمو اللغوي وتحديد نقاط القوه والضعف لدي الطفل'),
                ...
                IntroductionToCommunicationScienceButton(
                  ...
                  onTap: (){
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return DesignAPlanToAddressDelayedLanguageGrowth(
                            title: 'تصميم خطة لعلاج تأخر النمو اللغوي',
                            listOfRichTextWidget:  [
                              MapEntry(
                                  const Domain(text: 'تصميم خطه العلاج لتأخر النمو اللغوي'),
