...
class FaresReUseableScreen extends StatefulWidget {
   const FaresReUseableScreen(
      {Key? key,
      required this.title,
      this.titleImagePath,
 ...
 final String? titleImagePath;
  ...
  @override
  State<FaresReUseableScreen> createState() => _ReUseableScreenState();
}

class _ReUseableScreenState extends State<FaresReUseableScreen> {
